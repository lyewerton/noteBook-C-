...
class aula23
{
    static void Main()
    {
        ...
        {
            vetor1[i] = random.Next(50); // Next() - randomiza número aleatório qualquer // Next(50) - randomiza números até o n 49 //  Next (50, 100) - randomiza número do 50 ao 100
        }
        ...
        Console.WriteLine("Indice do primeiro valor3:{0}", indice1);
        Console.WriteLine("----------------------------------");
