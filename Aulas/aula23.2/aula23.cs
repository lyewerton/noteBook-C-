...
class aula23
{
    static void Main()
    {
        ...
        //public static void Copy(Ar_origem,Ar_destino,qtde_elementos); // Copia de um vetor para outro com COPY
        ...
        // vetor que receberá a cópia com COPY TO
        ...
        // diz o menor índice de um vetor
        ...
        // diz o maior Índice de um vetor
        ...
        //Procura um valor em determinada posição da matriz ou vetor
        ...
        //procura o primeiro indice com determinado valor
        ...
        //Procura o último índice com determinado valor
        ...
        //deixa a lista dos vetores em ao contrário, vindo do último ao primeiro
        ...
        //seta os valores de todos os índices de um vetor para determinado número
        ...
        //arruma em ordem crescente, poderia colocar o reverse depois e ficaria em ordem decrescente.
        Array.Sort(vetor1);
        Array.Sort(vetor2);
        Array.Sort(vetor3);
